...
1. policy gate evidence;
2. deep reliability evidence;
3. local Reality incumbent control;
4. performance against fully `SELECTABLE` alternatives.
...
|---|---|---|
| `REPLACE_REQUIRED` | `需要更换` | confirmed policy hard rejection; deep overall TLS success <95%; sufficiently sampled IP <90%; or clean Reality control failure |
